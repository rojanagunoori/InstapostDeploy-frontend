...
export default function ShareDialogBox() {
    ...
    return (
        <Fragment>
            ...
            {/* Dialog  */}
            <Dialog className=" relative right-[1em] w-[25em]  md:right-0 md:w-50 lg:right-0 lg:w-50" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* DialogBody  */}
                <DialogBody >
